...
const (
	...
	GSRULE_DATA_TYPE_PROTOCOL uint8 = 1
	GSRULE_DATA_TYPE_CPE      uint8 = 2
	GSRULE_DATA_TYPE_CPE23    uint8 = 3
	GSRULE_DATA_TYPE_CVE      uint8 = 4
	GSRULE_DATA_TYPE_CNVD     uint8 = 5
	GSRULE_DATA_TYPE_CNNVD    uint8 = 6
	GSRULE_DATA_TYPE_GO       uint8 = 7
	GSRULE_DATA_TYPE_PY       uint8 = 8
	GSRULE_DATA_TYPE_SH       uint8 = 9
	GSRULE_DATA_TYPE_OTHER    uint8 = 10
)
